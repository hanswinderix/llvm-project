...
static void BuildNOP1(MachineBasicBlock &MBB,
  ...
  BuildMI(MBB, I, DL, TII->get(MSP430::BIC16rc), MSP430::CG)
    .addReg(MSP430::PC)
    .addImm(1);
}
...
static void BuildNOP2(MachineBasicBlock &MBB,
  ...
  BuildMI(MBB, I, DL, TII->get(MSP430::BIC16ri), MSP430::CG)
    .addReg(MSP430::PC)
    .addImm(42);
}
...
static void BuildNOP41(MachineBasicBlock &MBB,
  ...
  // CLASS 41: SWPB16m  swpb &DMEM_DUMMY_ADDR
  BuildMI(MBB, I, DL, TII->get(MSP430::SWPB16m), MSP430::SR)
    .addGlobalAddress(getDummyData(MBB));
}
...
void MSP430NemesisDefenderPass::CanonicalizeSensitiveLoop(MachineLoop *Loop) {
  ...
  BuildNOP42(*NewPreheader, NewPreheader->end(), TII);
#endif
  BuildNOP1(*NewPreheader, NewPreheader->end(), TII);
...
#else
          /* DMA */
          BuildMI(*Preheader, T, DL, TII->get(MSP430::SUB16ri), MSP430::SP)
            .addImm(0)
            .addImm(2);
          BuildMI(*Preheader, T, DL, TII->get(MSP430::MOV16mr), MSP430::SP)
            .addImm(0)
            .addReg(IReg);
#endif
...
unsigned MSP430NemesisDefenderPass::getLeakageClass(const MachineInstr &MI) {
  static unsigned Id2class[][2] = {
    ...
    */
    ...
    {0, 999}, {0, 999}, {0, 999}, {0, 999}, {0, 999}, {0, 999},
    {0, 999}, {0, 999}, {0, 999}, {0, 999}, {0, 999}, {0, 999},
    {0, 999}, {0, 999}, {41, 999}, {19, 999}, {24, 46}, {46, 999},
    {46, 999}, {41, 999}, {1, 999}, {2, 999}, {34, 58}, {58, 999},
    {58, 999}, {1, 999}, {41, 999}, {19, 999}, {24, 46}, {46, 999},
    {46, 999}, {41, 999}, {1, 999}, {2, 999}, {34, 58}, {58, 999},
    {58, 999}, {1, 999}, {41, 999}, {19, 999}, {24, 46}, {46, 999},
    {46, 999}, {41, 999}, {1, 999}, {2, 999}, {34, 58}, {58, 999},
    {58, 999}, {1, 999}, {41, 999}, {19, 999}, {24, 46}, {46, 999},
    {46, 999}, {41, 999}, {1, 999}, {2, 999}, {34, 58}, {58, 999},
    {58, 999}, {1, 999}, {0, 999}, {0, 999}, {0, 999}, {41, 999},
    {19, 999}, {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999},
    {19, 999}, {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999},
    {19, 999}, {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999},
    ...
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999},
    {19, 999}, {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {3, 999},
    {999, 999}, {2, 999}, {3, 999}, {999, 999}, {2, 999}, {999, 999},
    {999, 999}, {999, 999}, {999, 999}, {999, 999}, {41, 999}, {19, 999},
    {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999}, {2, 999},
    {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999}, {19, 999},
    {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999}, {2, 999},
    {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999}, {19, 999},
    {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999}, {2, 999},
    {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999}, {19, 999},
    {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999}, {2, 999},
    {34, 58}, {58, 999}, {58, 999}, {1, 999}, {2, 999}, {2, 999},
    {42, 999}, {20, 999}, {25, 47}, {47, 999}, {42, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {42, 999},
    {20, 999}, {25, 47}, {47, 999}, {42, 999}, {1, 999}, {2, 999},
    {34, 58}, {58, 999}, {58, 999}, {1, 999}, {34, 999}, {1, 999},
    {58, 999}, {999, 999}, {42, 999}, {999, 999}, {999, 999}, {999, 999},
    {999, 999}, {41, 999}, {999, 999}, {999, 999}, {1, 999}, {41, 999},
    {999, 999}, {999, 999}, {1, 999}, {41, 999}, {999, 999}, {999, 999},
    {1, 999}, {41, 999}, {999, 999}, {999, 999}, {1, 999}, {0, 999},
    {0, 999}, {41, 999}, {999, 999}, {999, 999}, {1, 999}, {41, 999},
    {19, 999}, {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999},
    {19, 999}, {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999},
    ...
    {19, 999}, {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999},
    {999, 999}, {999, 999}, {1, 999}, {0, 999}, {0, 999}, {0, 999},
    {0, 999}, {0, 999}, {0, 999}, {0, 999}, {0, 999}, {41, 999},
    {19, 999}, {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {41, 999},
    {19, 999}, {24, 46}, {46, 999}, {46, 999}, {41, 999}, {1, 999},
    {2, 999}, {34, 58}, {58, 999}, {58, 999}, {1, 999}, {1, 999}
  };
  ...
  if (E[1] != 999) {
    auto N = MI.getNumOperands();
    assert(N > 1);
    auto MO = MI.getOperand(N-1);
    if (MO.isImm()) {
      if (MO.getImm() == 0) {
        return E[1];
      }
